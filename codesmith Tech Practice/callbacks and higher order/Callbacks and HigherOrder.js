...
//       //invoke the callback function, passing in the current array element
//       callback(array[i]);
//     }
//   }
...
//     return result
//   }
//////can you answer using a forEach loop?
...
/////// can you answer using a filte array functin?
// let newArray = arr.filter(callback(currentValue[, index[, array]]) {
//     // return element for newArray, if true
//   }[, thisArg

// return array.filter(n => callback1([n]) || callback2([n]));
// }


// can you answer the question using a reduce function??
...
//   debugger;
//     //array.isArraymethod determines whether the passed value is an array
...
//       return acc.concat(currArray.filter(el => !acc.includes(el)))
//     })
//   }
//   Uncomment these to check your work!
//   const arr1 = [5, 10, 15];
...
//           newArrayOfObjects[el] = callback(arr2[index])
//         }
//     });
...
//////////////////////////////////////////////////////////////////// Challenge: objOfMatches ******tehre are a lot of examples.  study this.  
// answer the question above using reduce 
...
//         newObj[element].push(arr2[j](element));
//       } 
//     }
//     return newObj;
//   }
...
// //////////////////////////////////////////////////////////////////Challenge: multiMap
// how would you solve this with a reduce array?
const multiMap = (keys, cbs) => {
debugger
  keys.reduce(
    (obj, key) => Object.assign(obj, { [key]: cbs.map(cb => cb(key)) }),
    {}
  );
  }
...
//////////////////////////////////////// Challenge: majority
// can you answer this with a filter array?
// ADD CODE HERE
// function majority(arr, fxn){
//     const trueArray = arr.filter(elem => fxn(elem));
    
//     if(trueArray.length/arr.length > 0.5){
//       return true;
//     } else {
//       return false;
//     }
...
//////////////////////////////////////// Challenge: majority
// // can you answer this with reduce?
function majority(array,callback){
  debugger
    let occurrences = array.reduce((acc,initialVal) => 
                                  (callback(initialVal) ? acc+=1 : acc),0);
    // console.log(occurrences)
    return (occurrences>array.length/2) ? true:false;
  }
...
//     arr.forEach(elem => callback(elem) ? truth.push(elem) : falsy.push(elem))
...
///////how about with filter?
// // ADD CODE HERE
// const prioritize = (arr, callback) => {
//     debugger;
//     return [
//       ...arr.filter(elem => callback(elem)),
//       ...arr.filter(elem => !callback(elem))
//     ]
//   }
//   // Uncomment these to check your work!
...
// //////////how about wtih reduce?
// const prioritize = (arr,callback) => {
//     let result = arr.reduce((acc,curr) => {
//       (callback(curr)) ? acc[0].push(curr) : acc[1].push(curr)
//       return acc;
//     }, [[], []]);
