...
//         result = "Found Droids!"
//       } else {
//         result = "Thse are not the droids you're looking for."
//       }
//     })
//     return result;
//   }
...
//     return array1.map((elem, idx) => {
//       if (elem >= 10) return elem + evenSum + extraBonus;
      
//       if (elem <10) return elem + oddSum + extraBonus;
