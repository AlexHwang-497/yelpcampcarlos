...
//     // assign obj as empty array
//     let str = array[i]
//     obj[array[i]] = [];
//     // iterate thorugh callback w/ for...loop
...
// // //ADD CODE HERE
// function intersection(arrays){
//   // utilize on arrays, reduce method
//   return arrays.reduce((acc,curr)=>{
//     // utilzie filter mehtod on accumulator
//     return acc.filter(num =>
//       // utilize includes method on current value
//       curr.includes(num))
//   })
// }
...
// function intersection(arrays){
//   debugger;
//   // decalre variable as base array for comparison
//   let comp = arrays[0]
//   // iterate through arrays utilzing for loop
//   for(let i=0;i<arrays.length;i++){
//     let arr= arrays[i]
//     // iterate thorugh comparison/base array
//     for(let j=0; j<comp.length;j++){
//       let compVal = comp[j]
//       // intiate conditional stmtt; where if element is not included in  the array
//       if(!arr.includes(compVal)){
//         // slice the comparable//base array
//         comp.splice(j,1)
//       }
//     }
//   }
...
//     // concat accumulator
//     return acc.concat(
//       // filter out elements that not included in accumlator
...
function union(arrays){
  ...
  return arrays.reduce((acc,curr)=> {
    // iterate and utlize forEAch MEthod for current array
    curr.forEach(el =>{
      // intialize cond stmt where if the curr value/element is not found in the accumulator....
      if(!acc.includes(el)){
        // push the vlaue into the accumulator
        acc.push(el)
      }
    })
    return acc;
...
//   function print(args){
//     // intiate cond stmt; where if str is equal to the argument
//     if(str === args){
//       // retrun the object
//       return obj;
...
//       // otherwise....
//     } else {
//       // update/reassign key value pair/object
//       obj[args]  = func(args)

//         // invoke callback and return invoked value;
//         return obj[args]
...
//   for(let num of arr){
//     // intiate cond stameent; if key/value pair exists...
//     if(fn(num) in obj){
//       // increment the key value pair
//       obj[fn(num)]++
//       // otherwise....
//     }else {
//       // assign/update key value pair to 1
//       obj[fn(num)] = 1
//     }
//   }
//   // return key/value pair and/or object
//   return obj;
// }
...
//   // declare varaible as empty object
//   let obj={};
//   // iterate thorugh array w/ for...of loop
//   for(let num of array){
//     // udpate/reassign key value pairs with invoked callback value
...
// //  an array consisting only the keys whose associated values yielded a true return value from the callback.
 ...
 function goodKeys(obj, callback) {
  //  declare variable as empty array for storage
  let result = [];
    // iterate through obj w/ for..in loop
    for(let key in obj){
      // intiate cond stmt; where if invoked callbkck is truthy...
      if(callback(obj[key])){
        // push invocked callback value into array
        result.push(key)
      }
    }
    // return result
