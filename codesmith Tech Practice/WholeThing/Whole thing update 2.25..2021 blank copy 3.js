...
//   //reverse the array
//   .reverse()
//   //convert the array back to the striing
//   .join('')
// }

// //////////////////////////////solve using a for looop///////////////
// function reverse(str){
//   //declare a variable called 'reverse' and assign it split string
//   let splits = str.split('')
//   //declare a variable called 'result' that will assign an empty string;
//   let result =''
//   // iterate through splits  with a for loop
//   for(let i=0;i<str.length;i++){
//     //update result where it will  be assigned splits + reuslt;
...
// // ////////////////////////////// using for of loop///////////////
// function reverse(str){
// //   //declare a variable called result and assign it as an empty string

//   let result = ''
// //   //for..of loop to iterate through the elemnets of the string
//   for(let i of str){
//     //result will be assigned the element of i + the result;
//     result = i+result;
//   }
//   //return results
//   return result;
...
// function reverse(str){
//   //declare variable arr;  variable will be assigned the split of str;
//   let arr = str.split('')
//   //
...
//   // declare variable called result and assign it an empty string;
//   let result = '';
//   //iterate for..of loop through the str;
//   for(let char of str){
//     //assign result the value of str[i] + result;
//     result = char + result;
//   } ;

//   //retrun our result; if result is equal to str, assign true whcih proves our string is a palindrome
//     return str === result;
...
//   //return the value where if str === reversed; then str is a palindrome
//   return reversed === str;
...
//   //decalre a variable called convert and convert number to string
//   let convert = n.toString()
//   //split the numbers into an array
//   .split('')
//   //reverse the numbers
//   .reverse()
//   //join the array and convert into a string
//   .join('');

//   //return converted number and multipy by Math.Sign function
//   return convert<0? parseInt(convert)*-1:parseInt(convert)*Math.sign(n)
...
//   //declare a variable called obj and assign it as an empty object
//   let obj={}
//   //iterate throught the string using a for...of loop
//   for(let char of str){
//     //update our object
//     obj[char] = obj[char] + 1 ||1
//   }
// //utilizng Object cosntructur and reduce fucntion, return larrgest key value from object
...
// function fizzBuzz(n) {
//   //if number is divisible by five and three, print 'fizzbuzz'
//   for(let i=1; i<=n;i++){
//     if(i%3===0 && i%5===0){
...
//     } else if(i%5===0){
//       console.log('buzz')
//       //if nubmer is divisble by 3, print 'fizz'
//     } else if(i%3===0){
//       console.log('fizz')
//       //all other number return the number
//     } else {
//       console.log(i)
//     }
//   }
...
//   //declare a variable result as an empty array
//   let result = [];
//   //iterate throught the array using a for loop
//   for(let i=0; i<array.length;i++){
//     //decare a variable last and assign it the array our our chunked array based on size
//     let last = result[result.length-1]
//     //initiate an if statmeent where if the last variable doesn't exist or the length of last array = size
//     if(!last || last.length === size){
//       //update our result by pushing current element into reuslt
//       result.push([array[i]])
//       //we wil push current element into last array if if statmetment does not intiate
//     }else {
//       last.push(array[i])
//     }
//   }
...
// ///////////alternate solution///////////////
// function chunk(array,size){
//   //decalre a variable called result and assign it an empty array
//   let result = []
//   //iterate throug the array using a for loop.  we will increment the loop by the value of size
//   for(let i=0; i<array.length;i+=size){
//     //push the result of the sliced array into result;  
...
//   //declare a variable StringASort and assign it the split into an array sort the string in alphabetical order of StringA
//    stringASort = stringA.split('').sort().join('')
//   //declare a variable StringBSort and assign it the split into an array sort the string in alphabetical order of StringB
//    stringBSort = stringB.split('').sort().join('')

//    //if the sorted strings equal each other. we will return a value of true;
...
// function capitalize(str){
//   //declare a variable named result and assign it as an empty array
//   let result =[];
//   //declare a variable named convert and split string and convert into an array
//   let convert = str.split(' ')
//   //iterate through convert with a for..in loop
//   for(let word of convert){
//     //capitalize first initial in each element and update/push into result;
...
///////////////////////solution/////////////////////
function vowels(str) {
  //declare variable vowels that are asiigned all vowels in the alphabet
  let vowels = ['a','e','i','o','u'];
  //declare variable obj and assign it an empty object;
  let obj = {};
  //interate through str with a for..of loop.  
  for(let element of str.toLowerCase()){
    //update object with elemenet and to count the value of objects 
    obj[element] = obj[element] + 1 || 1
  }
  // return Object.keys(obj).filter(letter => vowels.includes(letter)).
