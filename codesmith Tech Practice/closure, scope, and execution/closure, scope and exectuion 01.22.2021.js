...
// //declare a function called "createFunctionWithInput" and we include the parameter of "input"
// function createFunctionWithInput(input){
//     //create a function called "printInput"
//     function printInput(){
...
// //declare a function named "addByX" with a parameter of "num"
// function addByX(num){
//     console.log('num: ' +num)
//     function sum(x){
//         console.log('x: ' +x)
...
//     //this will indicate if the callback has been called
//     let called = false;
//     //create a variable "result" to store our results of the callback invocation
//     let result = undefined;
//     //create function calledOnce
//     function calledOnce(args){
//         //if callback hasn't been called; initiate the following if statmene
//         if(!called){
//             // invoke the callback and store the callback in result when invoked
//             called = true;
...
// //declare a function named "after" with the parameters of "num" and "callback"
// function after(num,callback){
//     //declare a variable counter and let =0;  we utilize counter as a way to track how many times the callback has been called
//     let count =0;
//     //create a return function
//     return function calledNum(...args){
//         //each time our return function is called, we will increment our count
//         count++;
//         //we will intiate an if statement to determine when our num = count; where we will initialte our callback
//         if(count>=num){
